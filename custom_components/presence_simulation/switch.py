...
class PresenceSimulationSwitch(SwitchEntity,RestoreEntity):
    ...
    def update_config(self, config):
        ...
        self._dry_run = conf.get("dry_run", False)
    ...
    @property
    def dry_run(self):
        return self._dry_run_overriden
    ...
    async def reset_default_values_async(self):
        ...
        self._dry_run_overriden = self._dry_run
    ...
    async def set_dry_run(self, dry_run):
        self.attr["dry_run"] = dry_run
        self._dry_run_overriden = dry_run
    ...
    async def reset_dry_run(self):
        if "dry_run" in self.attr:
            del self.attr["dry_run"]
