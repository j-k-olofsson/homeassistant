...
rotation_schema = sensor.sensor_schema(unit_of_measurement = UNIT_DEGREES, icon = ICON_ROTATE_RIGHT, accuracy_decimals = 1)

CONF_ACCEL_X = "in_accel_x"
CONF_ACCEL_Y = "in_accel_y"
CONF_ACCEL_Z = "in_accel_z"

CONFIG_SCHEMA = sensor.sensor_schema(unit_of_measurement = UNIT_DEGREES, icon = ICON_ROTATE_RIGHT, accuracy_decimals = 1).extend({
